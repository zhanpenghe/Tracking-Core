...
(function(e,t){
    ...
    return e.$===t&&(e.$=n),n.fn=n.prototype={
        ...
        css:function(e,r){
            ...
            if(typeof e=="string"){
                ...
                }else for(i in o)i==="opacity"?n.opacity.set(s,o[i]):s.style[i]=o[i];return this
            },
        show:function(){
    ...
    if(t){
        delete u[t];
        for(var a in u)r=!1;r&&delete n.cache[o]
    ...
    remove:function(e,t,r){
        ...
        if(!f)return;
        if(!t){
            for(i in f)u.remove(e,i);return
        }
        s=f[t];
        if(!s)return;
        o=s.listeners;
        ...
        if(s.listeners.length===0){
            ...
            for(var l in s)a=!1;a&&n.removeData(e,"@events")
            }
        },
handler:function(t){
    return function(r){
...
return p.curAnim={},n.each(e,function(e,t){
    ...
    step:function(){
        ...
        if(t>=e.options.speed+e.startTime){
            ...
            for(var i in e.options.curAnim)e.options.curAnim[i]!==!0&&(r=!1);return r&&e.options.callback.call(e.elem),!1
            }
            var s=t-e.startTime;
    ...
    var r,i,s,o,u=0,a=e(t),f=e(document),l=e("html"),c=document.documentElement,h=t.VBArray&&!t.XMLHttpRequest,p="createTouch"in document&&!("onmousemove"in c)||/(iPhone|iPad|iPod)/i.test(navigator.userAgent),d="artDialog"+ +(new Date),v=function(t,i,s){
        ...
        for(var l in a)t[l]===n&&(t[l]=a[l]);return e.each({
            ok:"yesFn",
            cancel:"noFn",
            close:"closeFn",
            init:"initFn",
    ...
    v.fn=v.prototype={
        ...
        close:function(){
            ...
            for(var a in e)e.hasOwnProperty(a)&&a!=="DOM"&&delete e[a];return r?i.remove():r=e,e
            },
        time:function(e){
...
_removeEvent:function(){
    ...
    for(t in e)e[t].src&&e[t].src.indexOf("artDialog")!==-1&&(n=e[t]);return i=n||e[e.length-1],n=i.src.replace(/\\/g,"/"),n.lastIndexOf("/")<0?".":n.substring(0,n.lastIndexOf("/"))
...
v._templates='<div class="aui_outer"><table class="aui_border"><tbody><tr><td class="aui_nw"></td><td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td><td class="aui_c"><div class="aui_inner"><table class="aui_dialog"><tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div class="aui_title" style="width:0px;height:0px;"></div><a class="aui_close" href="javascript:/*artDialog*/;">\u00d7</a></div></td></tr><tr><td class="aui_icon"><div class="aui_iconBg"></div></td><td class="aui_main"><div class="aui_content"></div></td></tr><tr><td colspan="2" class="aui_footer"><div class="aui_buttons"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td class="aui_se"></td></tr></tbody></table></div>',v.defaults={
