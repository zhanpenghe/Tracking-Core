...
function chord_draw(Matrix,Keys,Comment) {
	...
	ticks.append("svg:image")
	    ...
	    .attr("xlink:href", function(d) {
	      return "/images/avatars/"+(g_AvatarIconIDs[d.tag_id]?d.tag_id:'none')+".png";
	    })
...
{
  d3.json('/get/brucon.json', process_server);
...
d3.json('/images/avatars/list.json', get_avatars);
